...
public sealed class ScriptInjectionStartupFilterTests
{
    ...
    {
        Assert.Equal(new Version(0, 6, 2, 0), typeof(ScriptInjectionStartupFilter).Assembly.GetName().Version);
    }
    ...
    public void InjectScriptAddsTheAllocineEndpointBeforeBodyOnce()
    {
        ...
        Assert.Contains("<script src=\"/Allocine/Script?v=0.6.2\" defer></script>\n</body>", once, StringComparison.Ordinal);
    ...
    public void InjectScriptUsesConfiguredPathBase()
    {
        ...
        Assert.Contains("src=\"/jellyfin/Allocine/Script?v=0.6.2\"", injected, StringComparison.Ordinal);
    }
