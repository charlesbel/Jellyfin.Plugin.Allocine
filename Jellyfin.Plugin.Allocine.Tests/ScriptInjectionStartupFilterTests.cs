...
public sealed class ScriptInjectionStartupFilterTests
{
    ...
    {
        Assert.Equal(new Version(0, 5, 0, 0), typeof(ScriptInjectionStartupFilter).Assembly.GetName().Version);
    }
    ...
    public void InjectScriptAddsTheAllocineEndpointBeforeBodyOnce()
    {
        ...
        Assert.Contains("<script src=\"/Allocine/Script?v=0.5.0\" defer></script>\n</body>", once, StringComparison.Ordinal);
    ...
    public void InjectScriptUsesConfiguredPathBase()
    {
        ...
        Assert.Contains("src=\"/jellyfin/Allocine/Script?v=0.5.0\"", injected, StringComparison.Ordinal);
    }
